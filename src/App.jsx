...
export default function App() {
  ...
  // Makale istatistiklerini almak için bir getStats fonksiyonu tanımlıyoruz. Bu fonksiyon, favori, arşivlenmiş ve çöpe atılmış makale sayılarını hesaplar. //
...
// Makaleleri beğenme, arşivleme, çöpe atma ve genişletme işlevlerini tanımlıyoruz. Bu işlevler, verilen makale ID'sine göre ilgili işlemleri yapar ve makale listesini günceller. //
 ...
 */
  ...
  // Ana bileşenimizin return kısmında "articles-container" div'ine tek bir onClick olay işleyicisi ekliyoruz. Bu olay işleyicisi butonların (button-type) ve (article-id) veri niteliklerini kullanarak ilgili işlemleri gerçekleştirir. //
  return (
    <div className='wrapper'>
      <Header stats={stats} setArticleQueue={setArticleQueue} />
         ...
         onClick={(e) => {
           // const buttonType = e.target.dataset.buttonType: Tıklanan elementin buttonType veri özniteliği alınır. Bu öznitelik, hangi tür işlemin gerçekleştirileceğini belirler. Örneğin "favorite" (favorilere ekle), "archive" (arşive ekle), "trash" (çöpe taşı) veya "toggleExpand" (genişlet/daralt) gibi. //
           const buttonType = e.target.dataset.buttonType
           // const articleId = e.target.dataset.articleId: Tıklanan elementin articleId veri özniteliği alınır. Bu öznitelik hangi makalenin işlem yapılacağını belirtir. //
